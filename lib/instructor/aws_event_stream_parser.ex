  ...
  defp parse_headers(<<name_length::8, rest::binary>>, acc) do
    ...
    {value, rest} =
      case type do
        ...
        4 ->
          <<_::32, rest::binary>> = rest
          {nil, rest}

        5 ->
          <<_::64, rest::binary>> = rest
          {nil, rest}

        6 ->
          <<len::16, _::binary-size(len), rest::binary>> = rest
          {nil, rest}

        7 ->
          <<len::16, value::binary-size(len), rest::binary>> = rest
          {value, rest}
        ...
        9 ->
          <<_::binary-size(16), rest::binary>> = rest
          {nil, rest}
      end
